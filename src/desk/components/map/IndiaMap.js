...
function IndiaMap() {
  ...
  return (
    <div className="full-width-height container" >
      <div style={{margin:10,paddingLeft:10, width:200,backgroundColor:'white', borderRadius:5, border: "1px solid red"}} onClick={onChangeButtonClick}>
                    <p style={{fontSize: 10,margin:0,padding:0}}>Number of Students from States and UTs</p>
      </div>
      <ReactTooltip>{tooltipContent}</ReactTooltip>
        ...
        <div className="center"> 
          <button className="mt16" style={{borderRadius:10}} onClick={onChangeButtonClick}>Change</button>
        </div>
        */
        }
